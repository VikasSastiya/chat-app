...
const Header: React.FC<HeaderProps> = ({ conversation }) => {
    ...
    return (
        <>
            ...
            <div
                className={
                    "bg-white dark:bg-gray-900 w-full flex border-b-[1px] sm:px-4 py-3 px-4 lg:px-6 justify-between items-center shadow-sm"
                }
            >
                <div className={"flex gap-3 items-center"}>
                    <Link
                        href={"/conversations"}
                        className={
                            "lg:hidden block text-purple-500 hover:text-purple-600 transition cursor-pointer"
                        }
                    >
                    ...
                    <div className={"flex flex-col"}>
                        ...
                        <div className={`text-sm font-light ${isActive}`}>
                            {statusText}
                        </div>
                    </div>
                </div>
                <HiEllipsisHorizontal
                    ...
                    className={
                        "text-purple-500 cursor-pointer hover:text-purple-600 transition"
                    }
                />
            </div>
        </>
